...
uses
  ...
  , Model
  , Orders, Order
  , Customers, Customer, Data.DB, Vcl.DBGrids, InstantPresentation;
...
type
  TVCLOrdersFrm = class(TForm, IInterface, IOrdersView)
    ...
    OrdersSelector: TInstantSelector;
...
begin
  Result := OrdersSelector.CurrentObject as TOrder;
end;
...
begin
  ...
  try
    ...
    begin
      LOrder.AddRef;
      OrdersSelector.AddObject(LOrder);
    end;
    OrdersSelector.Open;
  finally
    OrdersSelector.EnableControls;
  end;
end;
